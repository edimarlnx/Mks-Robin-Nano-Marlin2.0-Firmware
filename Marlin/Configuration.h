...
#define STRING_CONFIG_H_AUTHOR "Edimar Cardoso" // Who made the changes.
...
#define CUSTOM_MACHINE_NAME "Hellbot Magna 2 Dual 230"
 ...
 *
 */
#define ADC_RESOLUTION          12 // Required to read correct values for temperature sensors
 ...
 */
#define DEFAULT_AXIS_STEPS_PER_UNIT   { 80, 80, 400, 444 }
 ...
 *
 * BUGFIX: Using Z_MAX (PC4/E0_DIAG_PIN) as probe since that's where BLTouch is connected
 */
#define Z_MIN_PROBE_PIN PC4 // PC4 = Z_MAX pin on MKS Robin Nano V3
 ...
 *     O-- FRONT --+
 */
#define NOZZLE_TO_PROBE_OFFSET { -43, -6, -1.90 }
